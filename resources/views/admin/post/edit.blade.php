            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('post.update', $post->id) }}" method="POST" class="needs-validation"
                            novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_ru" class="form-control"
                                                id="exampleInputEmail1" placeholder="Введите название статьи"
                                                value="{{ $post->title_ru }}">
                                            @error('title_ru')
                                                <p class="text-danger small">{{ $message }}</p>
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col-1">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="is_carousel"
                                                ...
                                                @if($post->is_carousel) checked value="1" @endif>
                                            @error('is_carousel')
                                                <p class="text-danger small">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <input type="text" value="{{ $post->img }}" name="img"
                                        class="form-control" id="feature_image" name="feature_image" value=""
                                        readonly>
