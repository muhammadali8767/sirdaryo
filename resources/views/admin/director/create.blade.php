                        ...
                        <form action="{{ route('director.store') }}" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="job_title_uz"
                                                ...
                                                id="exampleInputEmail1" required value="{{ old('job_title_uz') }}">
                                            @error('job_title_uz')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fullname_uz"
                                                ...
                                                id="exampleInputEmail1" required value="{{ old('fullname_uz') }}">
                                            @error('fullname_uz')
                                                <p class="text-danger small">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="biography_ru" class="editor" required>{{ old('biography_ru') }}</textarea>
                                            <div class="invalid-feedback">
                                                Please fill a valid data.
                                            </div>
                                            @error('biography_ru')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="obligation_ru" class="editor" required>{{ old('obligation_ru') }}</textarea>
                                            <div class="invalid-feedback">
                                                Please fill a valid data.
                                            </div>
                                            @error('obligation_ru')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="activity_ru" class="editor" required>{{ old('activity_ru') }}</textarea>
                                            <div class="invalid-feedback">
                                                Please fill a valid data.
                                            </div>
                                            @error('activity_ru')
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="biography_en" class="editor" required>{{ old('biography_en') }}</textarea>
                                            <div class="invalid-feedback">
                                                Please fill a valid data.
                                            </div>
                                            @error('biography_en')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="obligation_en" class="editor" required>{{ old('obligation_en') }}</textarea>
                                            <div class="invalid-feedback">
                                                Please fill a valid data.
                                            </div>
                                            @error('obligation_en')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="activity_en" class="editor" required>{{ old('activity_en') }}</textarea>
                                            <div class="invalid-feedback">
                                                Please fill a valid data.
                                            </div>
                                            @error('activity_en')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="reception_times"
                                    ...
                                    id="exampleInputEmail1" required value="{{ old('reception_times') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fb_link"
                                    ...
                                    id="exampleInputEmail1" required value="{{ old('fb_link') }}">
                                @error('fb_link')
                                    <p class="text-danger small">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="tw_link"
                                    ...
                                    id="exampleInputEmail1" required value="{{ old('tw_link') }}">
                                @error('tw_link')
                                    <p class="text-danger small">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="ig_link"
                                    ...
                                    id="exampleInputEmail1" required value="{{ old('ig_link') }}">
                                @error('ig_link')
                                    <p class="text-danger small">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Линкед ин</label>
                                <input type="text" name="in_link"
                                    class="form-control @error('in_link') is-invalid @enderror"
                                    id="exampleInputEmail1" required value="{{ old('in_link') }}">
                                @error('in_link')
                                    <p class="text-danger small">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Ютуб</label>
                                <input type="text" name="yt_link"
                                    class="form-control @error('yt_link') is-invalid @enderror"
                                    id="exampleInputEmail1" required value="{{ old('yt_link') }}">
                                @error('yt_link')
                                    <p class="text-danger small">{{ $message }}</p>
                                @enderror
                            </div>
